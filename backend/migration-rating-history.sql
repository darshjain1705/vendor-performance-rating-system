-- Rating history and approver correction support.
-- Run after schema.sql and migration-full-fidelity.sql.
-- Safe for existing data: current ratings remain the source of truth; the
-- backfill below records them as the initial baseline version.
